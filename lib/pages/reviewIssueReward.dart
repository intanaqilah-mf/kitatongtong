...
class ReviewIssueReward extends StatefulWidget {
  @override
  _ReviewIssueRewardState createState() =>
      _ReviewIssueRewardState();
}

class _ReviewIssueRewardState extends State<ReviewIssueReward> {
